...
type
  ...
  procedure UdskrivUafsluttedeListe;

var
  UdUafslutForm: TUdUafslutForm;
...
procedure TUdUafslutForm.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TUdUafslutForm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TUdUafslutForm.FormActivate(Sender: TObject);
begin
  dtFra.SetFocus;
end;

procedure TUdUafslutForm.ButOKClick(Sender: TObject);
var
  PakkeNr : LongWord;
begin with MainDm, MatrixPrnForm do begin
...
procedure TUdUafslutForm.UdskrivListe;
var
  LinNr : Word;
begin with MainDm, MatrixPrnForm do begin
  ffEksOvr.First;
