object HumanForm: THumanForm
  ...
  object paBund: TPanel
    ...
    object meEtiketter: TMemo
      ...
      TabOrder = 14
      OnChange = meEtiketterChange
      OnEnter = meEtiketterEnter
    end
  ...
  object paLinier: TPanel
    ...
    object grLinier: TDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = grLinierCellClick
      OnDrawColumnCell = grLinierDrawColumnCell
      OnMouseDown = grLinierMouseDown
    end
  end
  object ActionList1: TActionList
    ...
    object acPIBVar: TAction
      Caption = 'Vis PIB'
      ShortCut = 115
      OnExecute = acPIBVarExecute
    end
  end
  object dsLinDisp: TDataSource
    DataSet = cdsLinDisp
    Left = 336
    Top = 224
  end
  object cdsLinDisp: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 376
    Top = 264
  ...
  object ActionManager1: TActionManager
    ...
    object acShowPrescriptionDetails: TAction
      Caption = 'Vis Ord'
      ShortCut = 8308
      OnExecute = acShowPrescriptionDetailsExecute
      OnUpdate = acShowPrescriptionDetailsUpdate
    end
    object acVisPositivList: TAction
      Caption = 'Vis Positivilst'
      ShortCut = 118
